...
- By Julien Barbier
- Project to be done in teams of 2 people (your team: Edward Odey, Jesse Ekoh-Ordan
...
Even though our shell works locally, the checker still fails to pass all the checks.
Upon asking our colleagues on Slack, they suggested it might be memory leaks. We went on to fix the memory leaks but checker was persitent with the errors

## Reflection

Today is the deadline and our scores are well below 70%. We'd have to defer to another cohort. I'll spend the coming holiday preparing for next month
